...
import com.example.news.constant.SystemConstant;
...
//    public String getUsernameFromToken(String token) {
//       return Jwts.parser().setSigningKey(SystemConstant.SIGNING_KEY)
...
//    private <T> T getClaimFromToken(String token, Function<Claims, T> getExpiration) {
//    }
